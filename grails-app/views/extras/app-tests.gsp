...
<title>Testes da Aplicação</title>
	...
	<div class="container theme-showcase">
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<strong>Categorias e Links: </strong> Selecione categoria para visualizar links disponíveis
			</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="list-group">
									<g:remoteLink controller="categoria" action="ajaxLista"
										update="mainContent">
										listar categorias
											</g:remoteLink>
									<div id="mainContent">
									...
									<a href="#" class="list-group-item">sdasd ${nome } :sadasda</a>
