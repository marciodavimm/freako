...
<html lang="en">
  ...
  <body>
	...
	<div class="container theme-showcase">
      ...
      <img src="${resource(dir:'images', file:'programming-download.jpg')}" class="img-thumbnail" alt="A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera">
